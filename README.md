...
- No need to log in on every execution
...
Before running this project, you must create a Spotify Developer app.
...
Click Create app and fill in the basic information:

App name: Spotify Random Playlist Generator
App description: Personal CLI tool to create random playlists
...
After creating the app, open its settings and copy:

Client ID
Client Secret

These credentials are required by the CLI and must be exported as environment variables:
